...
<html lang="fr" class="no-js">
   ...
   <head>
      ...
      <title>PartyPix - Événement</title>
   ...
   <body>
      ...
      <div id="tabs" class="tabs">
         ...
         <h1 style="padding-bottom: 10px; text-align: center;">Événement</h1>
         ...
         <div class="content">
            <section id="section-1">
               <div class="mediabox">
                  ...
                  <br>
                  <p>L'emplacement de l'événement est : </p>
            ...
            <section id="section-5">
               <div class="mediabox">
                  ...
                  <br>
                  <p>Ajouter un moyen de transport : </p>
